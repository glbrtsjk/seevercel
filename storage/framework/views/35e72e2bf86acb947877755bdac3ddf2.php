<?php $__env->startSection('title', 'SEESEA - Jelajahi Lautan Konservasi'); ?>
...
<div class="relative overflow-hidden min-h-screen flex items-center">
    <div class="absolute inset-0 z-0">
        <img src ="<?php echo e(asset('home/oceanview.jpg')); ?>"  alt="Ocean Ecosystem" class="w-full h-full object-cover" />
      ...
      <div class="container mx-auto px-4 relative z-20 text-center">
        <div class="max-w-4xl mx-auto pt-40 pb-16">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in" style="animation-delay: 1500ms;">
                <a href="<?php echo e(route('articles.index')); ?>" class="group bg-white/90 text-blue-700 px-10 py-5 rounded-full font-bold hover:bg-white transition-all duration-300 shadow-2xl transform hover:-translate-y-2 hover:shadow-cyan-500/25 flex items-center">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('articles.create')); ?>" class="group bg-transparent border-2 border-white/50 backdrop-blur-sm px-10 py-5 rounded-full font-bold hover:bg-white hover:text-blue-700 transition-all duration-300 flex items-center">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="group bg-transparent border-2 border-white/50 backdrop-blur-sm px-10 py-5 rounded-full font-bold hover:bg-white hover:text-blue-700 transition-all duration-300 flex items-center">
                        <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="container mx-auto px-4 py-16 -mt-32 relative z-30">
        <div class="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 max-w-6xl mx-auto glow-border animate-on-scroll">
            ...
            <form action="<?php echo e(route('articles.search')); ?>" method="GET" class="flex flex-col lg:flex-row gap-4 animate-on-scroll">
                ...
                <div class="w-full lg:w-80">
                    <select name="category" class="w-full px-6 py-5 rounded-2xl border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 appearance-none bg-white/50 backdrop-blur-sm text-lg">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->category_id); ?>"><?php echo e($category->nama_kategori); ?></option>
            ...
            <div class="mt-8 flex flex-wrap gap-3 justify-center animate-on-scroll">
                ...
                <?php $__currentLoopData = $categories->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('articles.index', ['category' => $category->category_id])); ?>" class="bg-gradient-to-r from-cyan-50 to-blue-50 text-cyan-700 px-6 py-2 rounded-full text-sm hover:from-cyan-100 hover:to-blue-100 transition-all duration-300 border border-cyan-200 hover:border-cyan-300 transform hover:scale-105">
            ...
            <div class="flex-shrink-0 w-96 h-72 mx-4 rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-105 hover:rotate-1 gallery-card group">
                <div class="relative w-full h-full">
                    <?php if($article->gambar): ?>
                        <img src="<?php echo e(asset('storage/' . $article->gambar)); ?>" alt="<?php echo e($article->judul); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <?php else: ?>
                    ...
                    <div class="absolute top-4 right-4 bg-white/80 backdrop-blur-sm text-xs font-medium px-3 py-1 rounded-full flex items-center">
                      ...
                      <?php echo e($article->tgl_upload ? \App\Helpers\IndonesiaTimeHelper::diffForHumans($article->tgl_upload) : 'Baru'); ?>
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-blue-900/90 via-blue-700/70 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-6">
                        <?php if($article->category): ?>
                            <span class="bg-blue-500/80 backdrop-blur-sm text-white text-xs py-1 px-3 rounded-full w-fit mb-3 transform -translate-y-4 group-hover:translate-y-0 transition-all duration-500 delay-100">
                                <?php echo e($article->category->nama_kategori); ?>
                        ...
                        <p class="text-blue-100 text-sm mb-4 opacity-0 group-hover:opacity-100 transition-all duration-300 delay-150 line-clamp-2">
                            <?php echo e(Str::limit(strip_tags($article->konten_isi_artikel), 80)); ?>
                        ...
                        <div class="flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-200">
                            <div class="flex items-center">
                                <?php if($article->user && $article->user->profile_photo): ?>
                                    <img src="<?php echo e(asset('storage/' . $article->user->profile_photo)); ?>" alt="<?php echo e($article->user->name); ?>" class="w-8 h-8 rounded-full mr-2 border-2 border-white">
                                <?php else: ?>
                                ...
                                <?php endif; ?>
                                <span class="text-white text-xs"><?php echo e($article->user->name ?? 'Penulis'); ?></span>
                            </div>
                            <a href="<?php echo e(route('articles.show', $article->slug)); ?>" class="bg-white/20 backdrop-blur-sm text-white px-4 py-1.5 rounded-full text-sm hover:bg-white/40 transition flex items-center">
                                Baca
...
<div class="relative overflow-hidden mb-12  bg-gradient-to-b from-blue-100/8 blue-100/75 to-blue-100/80 ">
    ...
    <div class="flex auto-scroll py-10 px-14 relative">
        <div class="flex-shrink-0 w-96 h-72 mx-4 rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-105 hover:rotate-1 gallery-card group">
            <div class="relative w-full h-full">
                <img src="<?php echo e(asset('home/ocean1.jpg')); ?>" alt="Keindahan Terumbu Karang" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
        ...
        <div class="flex-shrink-0 w-96 h-72 mx-4 rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-105 hover:rotate-1 gallery-card group">
            <div class="relative w-full h-full">
                <img src="<?php echo e(asset('home/hewanlangkah.jpg')); ?>" alt="Hewan Laut Langka" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
        ...
        <div class="flex-shrink-0 w-96 h-72 mx-4 rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-105 hover:rotate-1 gallery-card group">
            <div class="relative w-full h-full">
                <img src="<?php echo e(asset('home/lautdalam.jpg')); ?>" alt="Laut Dalam" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
        ...
        <div class="flex-shrink-0 w-96 h-72 mx-4 rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-105 hover:rotate-1 gallery-card group">
            <div class="relative w-full h-full">
                <img src="<?php echo e(asset('home/mangrove.jpg')); ?>" alt="Ekosistem Mangrove" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
        ...
        <div class="flex-shrink-0 w-96 h-72 mx-4 rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-105 hover:rotate-1 gallery-card group">
            <div class="relative w-full h-full">
                <img src="<?php echo e(asset('beach.jpg')); ?>" alt="Keindahan Pantai" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
        ...
        <div class="flex-shrink-0 w-96 h-72 mx-4 rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-105 hover:rotate-1 gallery-card group">
            <div class="relative w-full h-full">
                <img src="<?php echo e(asset('home/konservasi.jpg')); ?>" alt="Konservasi Laut" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
            ...
            <div class="flex-shrink-0 w-96 h-72 mx-4 rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-105 hover:-rotate-1 gallery-card group">
                <div class="relative w-full h-full perspective">
                    <div class="card-inner relative w-full h-full transition-transform duration-700 transform-style-3d group-hover:rotate-y-15">
                        <?php if($article->gambar): ?>
                            <img src="<?php echo e(asset('storage/' . $article->gambar)); ?>" alt="<?php echo e($article->judul); ?>" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        <?php else: ?>
                        ...
                        <div class="absolute top-4 left-4 flex space-x-2">
                            <div class="flex items-center bg-black/50 backdrop-blur-sm text-white text-xs px-3 py-1 rounded-full">
                                ...
                                <?php echo e($article->view_count ?? rand(120, 999)); ?>
                            ...
                            <div class="flex items-center bg-black/50 backdrop-blur-sm text-white text-xs px-3 py-1 rounded-full">
                                ...
                                <?php echo e($article->reactions_count ?? rand(10, 99)); ?>
...
<div class="absolute top-1/2 right-0 transform -translate-y-1/2 z-10 opacity-30 rotate-180">
    ...
    <div class="container mx-auto px-4 py-20 relative z-20 bg-gradient-to-t from-blue-100/8 blue-100/75 to-blue-100/80">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <?php $__currentLoopData = $latestArticles->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="group card-hover card-3d bg-white/80 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl border border-white/50 h-full flex flex-col animate-on-scroll" style="animation-delay: <?php echo e($index * 0.2); ?>s">
                    <div class="card-3d-inner">
                        <div class="relative overflow-hidden h-64">
                            <?php if($article->gambar): ?>
                                <img src="<?php echo e(asset('storage/' . $article->gambar)); ?>" alt="<?php echo e($article->judul); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            <?php else: ?>
                                <div class="w-full h-full bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center">
                                    <svg class="w-20 h-20 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2-1-2 1M4 7l2-1M4 7l2 1M4 7v2.5M12 21l-2-1m2 1l2-1m-2 1v-2.5M6 18l-2-1v-2.5M18 18l2-1v-2.5"></path>
                        ...
                        <div class="p-8 flex-grow flex flex-col">
                            <h3 class="text-xl font-bold mb-4 text-gray-800 group-hover:text-cyan-700 transition-colors line-clamp-2">
                                <a href="<?php echo e(route('articles.show', $article->slug)); ?>"><?php echo e($article->judul); ?></a>
                            </h3>

                            <p class="text-gray-600 mb-6 line-clamp-3 flex-grow">
                                <?php echo e(Str::limit(strip_tags($article->konten_isi_artikel), 120)); ?>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100 mt-auto">
                                <div class="flex items-center">
                                    <?php if($article->user && $article->user->profile_photo): ?>
                                        <img src="<?php echo e(asset('storage/' . $article->user->profile_photo)); ?>" alt="<?php echo e($article->user->name); ?>" class="w-10 h-10 rounded-full mr-3 object-cover">
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                    <div>
                                        <p class="font-medium text-sm text-gray-800"><?php echo e($article->user->name ?? 'Penulis'); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($article->tgl_upload ? $article->tgl_upload->format('d M Y') : ''); ?></p>
                                    </div>
                                </div>
                                <a href="<?php echo e(route('articles.show', $article->slug)); ?>" class="text-cyan-600 hover:text-cyan-800 text-sm font-bold">
                                    Baca Selengkapnya →
                                </a>
                            </div>
                        </div>
        ...
        <div class="text-center animate-on-scroll">
            <a href="<?php echo e(route('articles.index')); ?>" class="inline-flex items-center bg-gradient-to-t from-sky-300 to-blue-300 text-white px-8 py-4 rounded-full font-bold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 shadow-xl transform hover:-translate-y-1 hover:shadow-cyan-500/25">
                <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="py-20 bg-gradient-to-b from-via-blue-100 to-blue-200/80 text-white relative overflow-hidden parallax">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center p-8 bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 card-hover animate-on-scroll" data-counter-value="<?php echo e($stats['publishedArticles']); ?>">
                    ...
                    <h3 class="text-4xl font-bold mb-2 text-white counter"><?php echo e($stats['publishedArticles']); ?></h3>
                    <p class="text-gray-600 font-medium">Artikel Diterbitkan</p>
                </div>
                <div class="text-center p-8 bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 card-hover animate-on-scroll" data-counter-value="<?php echo e($stats['activeUsers']); ?>">
                    ...
                    <h3 class="text-4xl font-bold mb-2 text-white counter"><?php echo e($stats['activeUsers']); ?></h3>
                    <p class="text-gray-600 font-medium">Anggota Komunitas Aktif</p>
                </div>

                <div class="text-center p-8 bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 card-hover animate-on-scroll" data-counter-value="<?php echo e($stats['funfactCount']); ?>">
                    ...
                    <h3 class="text-4xl font-bold mb-2 text-white counter"><?php echo e($stats['funfactCount']); ?></h3>
                    <p class="text-gray-600 font-medium">Fakta Laut Dibagikan</p>
                </div>

                <div class="text-center p-8 bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 card-hover animate-on-scroll" data-counter-value="<?php echo e($stats['reactionCount']); ?>">
                    ...
                    <h3 class="text-4xl font-bold mb-2 text-white counter"><?php echo e($stats['reactionCount']); ?></h3>
    ...
    <div class="bg-gradient-to-t from-via-blue-100 to-blue-200/80 py-20 relative ">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                <?php $__currentLoopData = $funfacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $funfact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group bg-white/70 backdrop-blur-lg rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/30 relative overflow-hidden animate-on-scroll" style="animation-delay: <?php echo e($index * 0.2); ?>s">
                        ...
                        <?php if($funfact->gambar): ?>
                            <div class="absolute top-4 right-4 w-16 h-16 opacity-30 rounded-full overflow-hidden group-hover:opacity-50 transition-opacity">
                                <img src="<?php echo e(asset('storage/' . $funfact->gambar)); ?>" alt="" class="w-full h-full object-cover">
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-4">
                                <span class="bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-xs font-bold px-4 py-2 rounded-full shadow-lg">
                                    Fakta #<?php echo e($funfact->urutan_animasi ?? $index + 1); ?>

                                </span>
                            </div>

                            <h3 class="text-xl font-bold mb-4 text-gray-800 group-hover:text-blue-700 transition-colors">
                                <?php echo e($funfact->judul); ?>

                            </h3>

                            <p class="text-gray-600 mb-6 leading-relaxed">
                                <?php echo e(app()->getLocale() === 'id' ? $funfact->deskripsi_id : ($funfact->deskripsi_en ?? $funfact->deskripsi_id)); ?>

                            </p>

                            <?php if($funfact->article_id): ?>
                                <a href="<?php echo e(route('articles.show', $funfact->article->slug ?? $funfact->article_id)); ?>"
            ...
            <div class="text-center">
                <a href="<?php echo e(route('funfacts.index')); ?>" class="inline-flex items-center px-8 py-4 bg-white border-2 border-blue-500 rounded-full text-blue-600 font-bold hover:bg-blue-50 transition-all duration-300 shadow-lg group animate-on-scroll">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                    </svg>
   ...
   <div class="bg-gradient-to-b from-via-blue-100 to-blue-100 py-20 relative">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 animate-on-scroll">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('articles.index', ['category' => $category->category_id])); ?>"
                   class="group bg-white/90 backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg hover:shadow-cyan-200/50 transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full">
                    <div class="h-32 overflow-hidden relative">
                        <img src="<?php echo e($category->image_url); ?>"
                             alt="<?php echo e($category->nama_kategori); ?>"
                    ...
                    <div class="p-4 flex flex-col justify-between flex-grow">
                        <div>
                            ...
                            <p class="text-xs text-gray-600 line-clamp-2">
                                <?php echo e($category->deskripsi); ?>

                            </p>
                        </div>
                        <div class="mt-3 flex justify-between items-center text-xs text-gray-500">
                            <span><?php echo e($category->articles->count()); ?> artikel</span>
            ...
            <div class="max-w-4xl mx-auto animate-on-scroll">
                ...
                <div class="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto text-reveal-delay-3">
                    <div class="text-center card-hover bg-white/10 rounded-xl backdrop-blur-md p-6">
                        <div class="text-3xl font-bold text-cyan-600 mb-2 counter"><?php echo e($stats['totalUsers'] ?? ($stats['activeUsers'] * 2)); ?>+</div>
                        <div class="text-gray-600 text-sm">Penjelajah Laut</div>
                    </div>
                    <div class="text-center card-hover bg-white/10 rounded-xl backdrop-blur-md p-6">
                        <div class="text-3xl font-bold text-cyan-600 mb-2 counter"><?php echo e($stats['publishedArticles']); ?>+</div>
                        <div class="text-gray-600 text-sm">Artikel Dipublikasikan</div>
                    </div>
                    <div class="text-center card-hover bg-white/10 rounded-xl backdrop-blur-md p-6">
                        <div class="text-3xl font-bold text-cyan-600 mb-2 counter"><?php echo e($categories->count()); ?>+</div>
        ...
        if (!oceanBg) {
            ...
            if (heroSection) {
                ...
                oceanBgDiv.innerHTML = `
                    <div class="absolute inset-0 bg-gradient-to-b from-blue-900/40 via-blue-700/30 to-teal-600/30 animate-pulse-slow"></div>
                    <div class="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-blue-900/80 to-transparent"></div>
                    <div class="absolute inset-0 bg-[url('<?php echo e(asset('home/bawahlaut.jpg')); ?>'] opacity-10 mix-blend-overlay animate-drift-slow"></div>
                `;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projectpwl\resources\views/home1.blade.php ENDPATH**/ ?>